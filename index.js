var CLOTHING = {
    ...
    collaredshirts: [
        ...
        },
        {
            collared: {
                description:
                    'Hidden-Button-Down Wrinkle-Free Cotton Twill Shirt',
                price: 89.99,
                stock: 10,
...
function oneJacket(x) {
    return [
        '<p class="product-description"><img src="' +
            x.jackets.image +
            '"/>&emsp;',
        '<br><br><p class="product-description">Price: $' +
            x.jackets.price +
            '</p>',
        '<p class="product-description">In Stock: ' + x.jackets.stock + '</p>',
...
function oneCollaredShirt(x) {
    return [
        ...
        '<br><br><p class="product-description">Price: $' +
            x.collared.price +
            '</p>',
        '<p class="product-description">In Stock: ' + x.collared.stock + '</p>',
        '<p class="product-description">Type: ' +
